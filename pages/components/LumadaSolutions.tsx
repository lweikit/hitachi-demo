  ...
  return (
    <Row>
      ...
      <Col xs={{ size: 12 }} lg={{ size: 4 }}>
        ...
        <p>
          สามารถช่วยเหลือผู้ผลิตในการประเมิน<br/>
          การซ่อมบำรุงเครื่องจักรล่วงหน้า<br/>
          ทั้งแบบทันการณ์และระยะไกล<br/>
          รวมถึงการฝึกอบรมให้กับ<br/>
          เจ้าหน้าที่หน้างานที่อยู่ต่างพื้นที่ด้วย<br/>
        </p>
      </Col>
    </Row>
  )
