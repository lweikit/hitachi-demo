    ...
    <div>
      ...
      }
      {
        activeIndex == 1 && (
          <div className={styles['description']}>
            <p>
              งานวิจัย McKinsey เปิดเผยว่าบริษัทในภูมิภาคอาเซียนประสบปัญหาการขาดแคลนผู้จัดการ<br/>
              ที่มีความเข้าใจในเทคโนโลยีและนวัตกรรมใหม่ที่สามารถประยุกต์ใช้กลยุทธ์ในการเปลี่ยนแปลงอย่างเหมาะสม<br/>
              และการขาดความรู้ความเข้าใจถึงกระบวนการทำงานใหม่ทั้งหมดนี้<br/>
              จะช่วยเพิ่มประสิทธิภาพการทำงานได้อย่างไร<br/>
            </p>
          </div>
        )
      }
