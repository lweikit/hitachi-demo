...
export default function AseanGDP() {
  return (
    <svg viewBox="0 0 100 25">
      <defs>
        <linearGradient id="part-two-gradient" x1="25" y1="-5" x2="5" y2="-20" gradientUnits="userSpaceOnUse">
