  ...
  return (
    <div id="section-four" className={`section ${styles['section-four']}`}>
      ...
      <div className={styles['quote-description']}>
        &#8220;ภาคการผลิตของภูมิภาคอาเซียนต้องทำการปฏิรูปทางดิจิทัล<br/>
        หากคิดจะปรับปรุงการแข่งขันเชิงต้นทุนและการแข่งขันเชิงความเสี่ยง<br/>
        ระบบปัญญาประดิษฐ์และระบบวิเคราะห์เป็นองค์ประกอบหลัก<br/>
      ...
      <h3>
        Hitachi ยังคงไม่หยุดนิ่งที่จะพัฒนาศักยภาพของศูนย์ Lumada<br/>
        ให้ก้าวไกลกว่าเดิมด้วยการร่วมมือกับคู่ค้า<br/>
        ที่มีความเชี่ยวชาญด้านการทำวิจัย<br/>
      </h3>
